      ...
      <Container maxWidth={"lg"}>
        <Stack direction={"row"} sx={{ mt: 10, mb: 10 }}>
          <Stack direction={"column"} width={"60%"}>
            <Stack direction={"row"}>
              <Typography variant="h3" color="#158ea8" sx={{ fontWeight: 600 }}>
                Makes everything feel easy
              </Typography>
            </Stack>
            <Stack direction={"row"} justifyContent={"center"} sx={{ mt: 3 }}>
              <Typography variant="h6">
                Aplication to control the smart devices available in your home
                remotely
              </Typography>
            </Stack>
            <Box
            ...
            >
              ...
              />
              <Typography variant="h6">
                Connected to various smart devices
              </Typography>
            </Box>
            <Box
              sx={{ display: "flex", alignItems: "flex-end" }}
            ...
            <Stack direction={"row"}>
              <Button
                variant="contained"
                sx={{ mt: 3, color: "#fff", backgroundColor: "#158ea8" }}
              >
